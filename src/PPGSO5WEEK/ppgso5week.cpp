...
#include "shader.h"
#include "mesh.h"
#include "ppgso5week_vert.h"
#include "ppgso5week_frag.h"
...
int main() {
    ...
    auto window = glfwCreateWindow( 1920, 1080, "PPGSO5WEEK", nullptr, nullptr);
    if (!window) {
    ...
    // Load shaders
    auto program = ShaderPtr(new Shader{ppgso5week_vert, ppgso5week_frag});
    program->Use();

    auto quad = Mesh{program, "quad.obj"};

    // Load and bind texture
    auto texture_id = LoadImage("velky_obrazok.rgb", 1920, 1080);
